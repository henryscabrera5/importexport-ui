    ...
    return {
        ...
        searchOptions: {
            ...
            commodities: {
                ...
                commodities: [],
                commoditiesExpanded: [],
                commoditiesManual: description.trim(),
                commodityGroups: {
                    systemGroups: [],
                    userGroups: []
                },
 ...
 */ async function searchCommoditiesViaGet(searchTerm) {
    try {
        // Try GET endpoint for commodity search - check if this exists
        const response = await fetch(`${BASE_URL}/api/v2/commodity/search?term=${encodeURIComponent(searchTerm)}`, {
            method: "GET",
            headers: {
...
"[project]/app/api/test-hts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        console.log("=".repeat(80));
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$usitc$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lookupHtsCodes"])(description);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5900fa11._.js.map